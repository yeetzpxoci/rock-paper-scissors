...
function stop() {
    document.getElementById("Rock").removeEventListener("click", clickPlay);
    document.getElementById("Paper").removeEventListener("click", clickPlay);
    document.getElementById("Scissors").removeEventListener("click", clickPlay);
    return;
}
