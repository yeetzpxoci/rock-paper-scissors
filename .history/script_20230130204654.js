...
document.getElementByClassName("Rock").addEventListener("click", playRound("rock", getComputerChoice()));
document.getElementByClassName("Paper").addEventListener("click", playRound("paper", getComputerChoice()));
document.getElementByClassName("Scissors").addEventListener("click", playRound("scissors", getComputerChoice()));
