...
document.getElementsByClassName(Rock, playRound("rock", getComputerChoice));
document.getElementsByClassName(Paper, playRound("paper", getComputerChoice));
document.getElementsByClassName(Scissors, playRound("scissors", getComputerChoice));
